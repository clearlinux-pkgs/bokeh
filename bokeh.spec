...
Source0  : https://files.pythonhosted.org/packages/82/4c/5f5aa9907fb2f545974caade9fb83ade57f5b5efc37641764145413e94ef/bokeh-2.3.1.tar.gz
...
%prep
%setup -q -n bokeh-2.3.1
cd %{_builddir}/bokeh-2.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617891441
...
cp %{_builddir}/bokeh-2.3.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/bokeh/dec8c96fb0595f54862fa8ad7e22f6cd48a07aa8
cp %{_builddir}/bokeh-2.3.1/bokeh/LICENSE.txt %{buildroot}/usr/share/package-licenses/bokeh/dec8c96fb0595f54862fa8ad7e22f6cd48a07aa8
