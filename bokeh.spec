...
Version  : 2.2.0
Release  : 55
URL      : https://files.pythonhosted.org/packages/bf/31/d71381ac3a5b822d1d83437e9bca3d7429319c62be1c42e98a9bc7b90d19/bokeh-2.2.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/bf/31/d71381ac3a5b822d1d83437e9bca3d7429319c62be1c42e98a9bc7b90d19/bokeh-2.2.0.tar.gz
...
%prep
%setup -q -n bokeh-2.2.0
cd %{_builddir}/bokeh-2.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598634584
...
cp %{_builddir}/bokeh-2.2.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/bokeh/19f653e42c734907a4384cd22d54edadf6f0c14e
cp %{_builddir}/bokeh-2.2.0/bokeh/LICENSE.txt %{buildroot}/usr/share/package-licenses/bokeh/19f653e42c734907a4384cd22d54edadf6f0c14e
