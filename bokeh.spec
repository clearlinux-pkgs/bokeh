...
Version  : 2.2.2
Release  : 58
URL      : https://files.pythonhosted.org/packages/6b/f4/cdd47dfb09ff1433bab0b870d21432a5455265e897993251f1e386bf970c/bokeh-2.2.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/6b/f4/cdd47dfb09ff1433bab0b870d21432a5455265e897993251f1e386bf970c/bokeh-2.2.2.tar.gz
...
%prep
%setup -q -n bokeh-2.2.2
cd %{_builddir}/bokeh-2.2.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602548427
...
cp %{_builddir}/bokeh-2.2.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/bokeh/19f653e42c734907a4384cd22d54edadf6f0c14e
cp %{_builddir}/bokeh-2.2.2/bokeh/LICENSE.txt %{buildroot}/usr/share/package-licenses/bokeh/19f653e42c734907a4384cd22d54edadf6f0c14e
