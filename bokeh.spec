...
Source0  : https://files.pythonhosted.org/packages/30/cf/9bef843880084b646cf5e6988e8f0aa081dccdf09f1617cfc6755f9a3353/bokeh-2.0.2.tar.gz
...
%prep
%setup -q -n bokeh-2.0.2
cd %{_builddir}/bokeh-2.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587601138
...
cp %{_builddir}/bokeh-2.0.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/bokeh/19f653e42c734907a4384cd22d54edadf6f0c14e
cp %{_builddir}/bokeh-2.0.2/bokeh/LICENSE.txt %{buildroot}/usr/share/package-licenses/bokeh/19f653e42c734907a4384cd22d54edadf6f0c14e
